    ...
    const generateAnalysis = async (studentToAnalyze: Student) => {
        ...
        const prompt = `
            ...
            **Analysis Instructions:**
            1.  **Risk Level:** Determine the student's academic risk level. Choose one: 'Low Risk', 'Needs Monitoring', 'At Risk'. 'At Risk' is for students who are failing terms or showing a sharp decline. 'Needs Monitoring' is for students with borderline scores or a substitute decline.
