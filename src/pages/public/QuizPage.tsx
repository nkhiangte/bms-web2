                    ...
                    <div className="space-y-8 text-slate-300 leading-relaxed">
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside mt-4 space-y-2">
                                ...
                                <li><strong className="text-white">Inter-House Competitions:</strong> Annual quiz competition where students represent their houses.</li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside mt-4 space-y-2">
                                ...
                                <li>Consistent participation in various regional quiz events.</li>
                            </ul>
                        </section>
                    </div>
