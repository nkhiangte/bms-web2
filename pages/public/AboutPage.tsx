            ...
            <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-2xl">
                    <div className="text-center">
                        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800">About Bethel Mission School, Champhai</h1>
                    </div>
                    ...
                    <div className="mt-12 space-y-10 text-slate-700 leading-relaxed">
                        <section>
                            ...
                            <p>Established in 1996, Bethel Mission School has a proud legacy of academic excellence under the Mizoram Board of School Education (MBSE). Guided by our motto, "Service to God & Men," we consistently achieve high pass percentages and distinctions in board exams, reflecting our commitment to quality education from Nursery to Class X.</p>
                        </section>
