                    ...
                    {/* Header Summary */}
                     <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 bg-slate-50 border rounded-lg">
                        <div>
                            ...
                            <p className="text-sm text-slate-600">Student Type: <span className="font-semibold text-slate-800">{admission.studentType}</span></p>
                            <p className="text-sm text-slate-600">Submitted: <span className="text-slate-800">{formatDateForDisplay(admission.submissionDate)}</span></p>
                        </div>
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                {updatingStatus ? <SpinnerIcon className="w-5 h-5 text-sky-600"/> : (
                                    <select 
                                        ...
                                        className="form-select text-sm text-slate-800 border-slate-300 shadow-sm focus:ring-sky-500 focus:border-sky-500 disabled:bg-slate-200 disabled:text-slate-500"
                                    >
