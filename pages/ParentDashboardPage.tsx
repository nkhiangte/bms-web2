...
import { User, Student, StudentStatus, StudentClaim } from '../types';
import PhotoWithFallback from '../components/PhotoWithFallback';
import { BookOpenIcon, CalendarDaysIcon, CurrencyDollarIcon, AcademicCapIcon, PlusIcon } from '../components/Icons';
...
const ParentDashboardPage: React.FC<ParentDashboardPageProps> = ({ user, allStudents, onLinkChild }) => {
    ...
    return (
        <>
                ...
                {linkedStudents.length > 0 ? (
                    <div>
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-bold text-slate-800">Your Children</h2>
                            <button onClick={() => setIsLinkModalOpen(true)} className="btn btn-secondary">
            ...
            <LinkChildModal
                ...
                onSubmit={onLinkChild}
                parentRelationship={user.registrationDetails?.relationship || 'Parent'}
            />
        </>
    );
};
