...
const PublicHomePage: React.FC<PublicHomePageProps> = ({ news, user }) => {
    ...
    return (
        <>
            ...
            {/* ── HERO SECTION ──
                Changed from calc(100vh - 128px) to 100vh.
                The old value assumed the header was floating on top of the hero.
                Now the header is solid/sticky above, so the hero just fills the viewport below it.
            -->*/}
            <section
